#!/usr/bin/env python3
"""
Mission 02: Two-Waypoint Navigation (Hardcoded Coordinates)

Navigates the Go2 robot to two waypoints sequentially:
  1. (46.86164631, -113.99780057)
  2. (46.86154957, -113.99796955)
...
Usage:
    python autonomous_nav/mission/mission_02.py
"""
...
# Waypoints
WAYPOINTS = [
    Waypoint(latitude=46.86164630854327, longitude=-113.9978005741553, name="waypoint_1"),
    Waypoint(latitude=46.86154956529314, longitude=-113.99796955331239, name="waypoint_2"),
]

# Navigation Configuration
ARRIVAL_TOLERANCE = 0.5  # meters - stop when within this distance
MAX_VELOCITY = 0.5  # m/s
ROTATION_RATE = 0.8  # rad/s - rotation speed when turning
GPS_FIX_TIMEOUT = 300  # seconds to wait for GPS fix
MIN_FIX_TYPE = 4  # Minimum fix quality (4=GNSS+DR or better)
...
def setup_logging():
    ...
    logfile = os.path.join(log_dir, f"mission_02_{timestamp}.log")
...
async def run_mission():
    ...
    print("=" * 60)
    print("RTK Mission 02: Two-Waypoint Navigation")
    print("=" * 60)
    print(f"Target tolerance: {ARRIVAL_TOLERANCE}m")
    print(f"Max velocity: {MAX_VELOCITY} m/s")
    print(f"Min fix type: {MIN_FIX_TYPE} (GNSS+DR or better)")
    ...
    try:
        ...
        # --- Step 4: Navigate waypoints ---
        print(f"\n[4/4] Navigating {len(WAYPOINTS)} waypoints...")
