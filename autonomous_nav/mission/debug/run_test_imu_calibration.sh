#!/bin/bash
# run_test_imu_calibration.sh — find robot, set env, run IMU calibration test
# Usage: bash autonomous_nav/mission/debug/run_test_imu_calibration.sh
...
python3 "$SCRIPT_DIR/test_imu_calibration.py"
