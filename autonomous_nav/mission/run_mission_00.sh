#!/bin/bash
# run_mission_00.sh — find robot, set env, run Mission 00 (single waypoint)
# Usage: bash autonomous_nav/mission/run_mission_00.sh
...
python3 "$SCRIPT_DIR/mission_00.py"
